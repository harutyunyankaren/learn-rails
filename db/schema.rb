...
ActiveRecord::Schema.define(version: 2018_05_11_083211) do
  ...
  create_table "private_conversations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
